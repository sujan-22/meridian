...
import { registerAccessMutations } from "./mutations/access";
...
import { registerAccessQueries } from "./queries/access";
...
function buildSchema() {
    ...
    registerAccessQueries(builder, refs);
    ...
    registerAccessMutations(builder, refs);
